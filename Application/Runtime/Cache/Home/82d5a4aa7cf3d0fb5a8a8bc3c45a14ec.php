...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="/Public/home/Images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
            <li><img src="/Public/Uploads/<?php echo session('user_pic')?>"  style="width: 20px;height: 15px"></img></li>
