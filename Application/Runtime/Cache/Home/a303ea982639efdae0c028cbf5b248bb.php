...
<head>
    ...
    <style type="text/css">
        ...
        .explode {
            background:url(/Public/home/Images/menu_minus.gif) no-repeat 0px 3px;
            font-weight:bold;
        }
        .collapse {
            background:url(/Public/home/Images/menu_plus.gif) no-repeat 0px 3px;
            font-weight:bold;
        }
        .menu-item {
            background:url(/Public/home/Images/menu_arrow.gif) no-repeat 0px 3px;
            font-weight:normal;
        }
        #help-title {
            font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/Public/home/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
    ...
    <div id="menu-list">
        <ul id="menu-ul">
            <li class="explode" key="02_cat_and_goods" name="menu">
                个人信息管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('User/edit');?>" target="main-frame">修改个人信息</a></li>
                    <li class="menu-item"><a href="<?php echo U('Email/add');?>" target="main-frame">站内信发送</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_goods" name="menu">
                好友管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Friends/add');?>" target="main-frame">添加好友</a></li>
                    <li class="menu-item"><a href="<?php echo U('Friends/lst');?>" target="main-frame">好友列表</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_goods" name="menu">
                系统功能
                <ul>
                    <li class="menu-item"><a href="<?php echo U('System/add');?>" target="main-frame">发送系统消息</a></li>
                    <li class="menu-item"><a href="<?php echo U('Friends/lst');?>" target="main-frame">好友列表</a></li>
                </ul>
            </li>
...
<script type="text/javascript" src="/Public/home/Js/utils.js"></script>
<script type="text/javascript" src="/Public/home/Js/transport.js"></script>
